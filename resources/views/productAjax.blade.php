...
<div class="container">
    <img src="{{ asset('images/logo1.png') }}" width="300px"/><br><br>
                ...
                <form id="productForm" name="productForm" class="form-horizontal">
                   <input type="hidden" name="product_id" id="product_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="status" name="status" placeholder="Enter Nama" value="" maxlength="50" required="">
                        </div>
                    </div>
